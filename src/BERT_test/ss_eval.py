...
if __name__ == "__main__":
    ...
    paras.output_folder = config.RESULT_PATH / 'train_2021_test'
    paras.original_data = read_json_rows(config.FEVER_TRAIN_JSONL)[:2]
    paras.upstream_data = read_json_rows(config.RESULT_PATH / 'train_2021/es_doc_10.jsonl')[:2]
    paras.sample_n = 10
    paras.top_n = [10]
