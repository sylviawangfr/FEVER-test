...
def concat_tmp_data():
    data_train = read_json_rows(config.RESULT_PATH / "sample_ss_graph_10000.jsonl")[0:5]
    ...
    data_dev = read_json_rows(config.RESULT_PATH / "sample_ss_graph_10180.jsonl")[0:2]
