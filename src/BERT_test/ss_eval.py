...
def eval_ss_and_save(saved_model, saved_tokenizer_model, upstream_data, pred=False, mode='dev'):
    ...
    original_list = read_json_rows(orginal_file)[2:3]
...
if __name__ == "__main__":
    ...
    # upstream_data1 = read_json_rows(config.RESULT_PATH / "dev_doc_retrieve.jsonl")[2:3]
    upstream_data2 = read_json_rows(config.RESULT_PATH / "dev_s_tfidf_retrieve.jsonl")[2:3]
