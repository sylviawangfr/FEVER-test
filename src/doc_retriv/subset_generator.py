...
def generate_subset_multi_evidence_articals():
    ...
    save_intermidiate_results(result_has_combination_evidence, config.RESULT_PATH / "hardset2021/dev_has_multi_evidence.jsonl")
    save_intermidiate_results(result_has_more_than_one_docs, config.RESULT_PATH / "hardset2021/dev_has_multi_doc_evidence.jsonl")
