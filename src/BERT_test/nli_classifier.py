...
def nli_finetuning(upstream_train_data, output_folder='fine_tunning', sampler=None):
    ...
    if do_eval and (local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        paras.upstream_data = read_json_rows(config.RESULT_PATH / "tfidf/dev_2019_06_15_15:48:58.jsonl")[0:10]
...
if __name__ == "__main__":
    ...
    train_data = read_json_rows(config.RESULT_PATH / 'train_2021/train_ss.jsonl')[0:200]
