...
if __name__ == "__main__":
    ...
    paras.original_data = read_json_rows(config.FEVER_TRAIN_JSONL)[72285:]
    paras.upstream_data = read_json_rows(config.RESULT_PATH / 'train_2021/es_doc_10.jsonl')[72285:]
    paras.sample_n = 10
    paras.top_n = [10]
