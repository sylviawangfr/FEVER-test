...
def fever_finetuning(taskname, save_model_path):
    ...
    parser.add_argument("--cache_dir",
                        default=config.PRO_ROOT / "saved_models/bert_finetuning_ss",
                        type=str,
    ...
    model = BertForSequenceClassification.from_pretrained(config.PRO_ROOT / "saved_models/bert/bert-large-uncased.tar.gz",
                                                          cache_dir=cache_dir,
...
if __name__ == "__main__":
    fever_finetuning('ss', config.RESULT_PATH / "bert_finetuning/test_ss")
