...
class GATLayer(nn.Module):
    ...
    # GAT paper uses
    # "first concatenation then linear projection"
    # to compute attention scores, while DGL is "first projection then
    # addition", the two approaches are mathematically equivalent:
    # We decompose the weight vector a mentioned in the paper into
    # [a_l || a_r], then
    # a^T [Wh_i || Wh_j] = a_l Wh_i + a_r Wh_j
    # DGL implementation is much efficient because it does not need to
